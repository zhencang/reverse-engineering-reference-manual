...
---
#### *<p align='center'> Using Functions from Dynamically Linked Libraries to Detect Debugger's Presence </p>*
---
...
---
* Record a timestamp, perform some operations, take another timestamp, and then compare the two timestamps. If there is a lag, you can assume the presence of a debugger
