...
* __Calling Conventions (x86)__: although there are various ways to set and clean up a function call, they all use CALL to transfer execution to a function
...
* __Jump Instruction__: different types of JMP 
  * __Short (Near) Jump__: uses relative addressing, but with only an 8-bit signed relative displacement
