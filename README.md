...
__NOTE(3)__: CI? We all hate broken links. The CI is my attempt to make sure all the links in the repo are still working. And if any of them is broken, I can easily pinpoint which one and swiftly update it with a new link.
